...
<body class="theme-<?php echo \IO\get_constant("PRJ_THEME"); ?>">
  ...
  <input type="hidden" data-setup="dnav" data-group="project-dev" data-clear-elem="#cwos-content" data-pos="affix" data-container="#cwos-content" data-get="/app/admin/get/navigation?group=project-dev" data-ini-top-pos="0" data-stick-on="">
  ...
  <section id="cwos-content">
    ...
    <div id="actn-btns">
      <div id="actn-btn-wrp">
        <div id="scrl-wrp">
          <button class="theme-button ashalt block" onclick="cwos.faderBox.url('/app/developer/post/user', {callback : 'requery'}, {exitBtn: true});"> <i class="fas fa-user-plus fa-lg"></i> New User</button>
        </div>
      </div>
